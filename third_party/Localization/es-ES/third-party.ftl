...
third-party-amazon-settings-import-installed-label = Importar juegos instalados
third-party-amazon-settings-import-uninstalled-label = Importar juegos no instalados
third-party-amazon-settings-connect-account = Conectar cuenta
third-party-amazon-login-checking = Comprobando el estado de la autenticación…
third-party-amazon-logged-in = El usuario está autenticado
third-party-amazon-not-logged-in = Requiere autenticación
third-party-amazon-not-logged-in-error = Fallo al autenticar usuario.
third-party-amazon-authenticate-label = Autenticar
third-party-amazon-settings-start-game-directly = Iniciar juegos directamente sin correr el cliente oficial
third-party-amazon-trouble-shooting-account-link = Resolución de problemas de sincronización de cuentas
third-party-amazon-trouble-shooting-issues = Resolución de problemas
third-party-amazon-settings-import-library-label = Importar todos los juegos
third-party-amazon-private-account = Cuenta Privada
third-party-amazon-public-account = Cuenta Pública
third-party-amazon-api-key = Clave de API
third-party-amazon-start-using-client = Iniciar usando el cliente { $var0 }
