...
third-party-amazon-private-account = Ιδιωτικός Λογαριασμός
third-party-amazon-public-account = Δημόσιος Λογαριασμός
third-party-amazon-api-key = Κλειδί API
third-party-amazon-start-using-client = Ξεκινήστε να χρησιμοποιείτε την εφαρμογή { $var0 }
