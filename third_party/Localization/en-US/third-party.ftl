...
third-party-amazon-settings-import-installed-label = Import installed games
third-party-amazon-settings-import-uninstalled-label = Import not installed games
third-party-amazon-settings-connect-account = Connect account
third-party-amazon-login-checking = Checking authentication status…
third-party-amazon-logged-in = User is authenticated
third-party-amazon-not-logged-in = Requires authentication
third-party-amazon-not-logged-in-error = Failed to authenticate user.
third-party-amazon-authenticate-label = Authenticate
third-party-amazon-settings-start-game-directly = Start games directly without running official client
third-party-amazon-trouble-shooting-account-link = Troubleshooting account sync issues
third-party-amazon-trouble-shooting-issues = Troubleshooting issues
third-party-amazon-settings-import-library-label = Import all games
third-party-amazon-private-account = Private Account
third-party-amazon-public-account = Public Account
third-party-amazon-api-key = API Key
third-party-amazon-start-using-client = Start using { $var0 } client
