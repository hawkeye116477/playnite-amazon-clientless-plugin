...
third-party-playnite-settings-label = Definições
...
third-party-amazon-not-logged-in-error = Falha ao autenticar utilizador.
...
third-party-amazon-trouble-shooting-account-link = Resolução de problemas de sincronização de conta
third-party-amazon-trouble-shooting-issues = Resolução de problemas
