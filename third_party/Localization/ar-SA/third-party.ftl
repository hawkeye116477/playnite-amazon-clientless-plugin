...
third-party-amazon-settings-import-installed-label = استيراد الألعاب المثبتة
third-party-amazon-settings-import-uninstalled-label = استيراد الألعاب الغير المثبتة
third-party-amazon-settings-connect-account = ربط الحساب
